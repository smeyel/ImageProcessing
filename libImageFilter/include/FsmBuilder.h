...
class FsmBuilder
{
	...
	unsigned int maxStateNumber;
	unsigned int currentStateNumber;
	unsigned int maxInputNumber;
	unsigned int currentInputNumber;

	// -------- For higher functions
	std::map<int,int> stateId2IdxMap;
	std::map<int,int> stateId2MaxcountMap;
	unsigned int nextFreeIdx;
	unsigned int currentIdx;
	unsigned int currentMaxCount;
