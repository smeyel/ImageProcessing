...
void FsmBuilder::all(unsigned int nextState)
{
	...
	for(unsigned int s=0; s<maxStateNumber; s++)
		for(unsigned int i=0; i<maxInputNumber; i++)
		{
...
void FsmBuilder::setTransition(unsigned int input, unsigned int nextStateID)
{
	...
	for(unsigned int i=0; i<currentMaxCount; i++)
...
void FsmBuilder::setCountingTransition(unsigned int input, unsigned int endStateID)
{
	...
	for(unsigned int i=0; i<currentMaxCount-1; i++)
...
void FsmBuilder::showCurrent()
{
	...
	for(unsigned int sp=0; sp<currentMaxCount; sp++)
	{
		for(unsigned int i=0; i<currentInputNumber; i++)
		{
